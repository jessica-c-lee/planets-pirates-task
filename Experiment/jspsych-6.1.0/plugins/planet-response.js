  ...
  plugin.info = {
    ...
    parameters: {
      ...
      ship_attack_damage: {
        ...
        default: 0.2,
        description:
          "Proportion of total points that an undefended encounter with the hostile ship removes.",
      },
      ship_hostile_idx: {
        type: jsPsych.plugins.parameterType.INT,
  ...
  plugin.trial = function (display_element, trial) {
    ...
    if (Array.isArray(trial.stimulus)) {
      for (var i = 0; i < trial.stimulus.length; i++) {
        ...
        html +=
          '<div id="planet-div-' + i + '" style="display:inline-block;"> ';
        html += '<div class="clickid" id="planet-score-box-' + i + '"></div> ';

        //Write img tag
        html +=
          '<img class="clickid" src="' +
          trial.stimulus[i] +
          '" ' +
          'id="planet-' +
          i +
        ...
        if (trial.prompt !== null) {
          html +=
            '<div class="clickid" id="planet-prompt-' +
            i +
        ...
        //Add signal box
        html +=
          '<div class="clickid" id="planet-signal-box-' +
          i +
          '" style="display:block; height:100px; width:100px"></div> ';
        //Add select ring divs
        html +=
          '<img id="planet-select-' + i + '" style="position:absolute;"> ';
        //End planet div
        html += "</div>";
        ...
        if (i + 1 < trial.stimulus.length) {
          html +=
            '<div id="ship-div" style="display:inline-block; ' +
            "vertical-align: top; " +
            "visibility:visible; " +
            "width:" +
            trial.ship_space +
    ...
    display_element.querySelector("#ship-img-box").innerHTML =
      '<div id="ship-img-div" ' +
    ...
    function updateStatus(choice, msg, color) {
      ...
      if (choice == "ship") {
        ...
        var statusDiv = display_element.querySelector(
